      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0 ">
            <h3 className="text-xs font-extrabold mb-4 ">KHAS</h3>
            <p className="text-gray-600 mb-2 text-xs ">224 County road, South New York 11968</p>
            <p className="text-gray-600 mb-2 text-xs ">info@khasstore.us</p>
            <p className="text-gray-600 mb-2 text-xs ">Pakistan (+92) 340 999 5954</p>
            <p className="text-gray-600 text-xs ">USA (+1) 347 315 6595</p>
            <div className="flex space-x-4 mt-4">
              <FaFacebookF className="text-gray-500 hover:text-black cursor-pointer " />
              <FaInstagram className="text-gray-500 hover:text-black cursor-pointer " />
              <FaTwitter className="text-gray-500 hover:text-black cursor-pointer " />
              <FaPinterest className="text-gray-500 hover:text-black cursor-pointer " />
              <FaSnapchatGhost className="text-gray-500 hover:text-black cursor-pointer " />
              <FaTiktok className="text-gray-500 hover:text-black cursor-pointer " />
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h3 className="text-xs font-extrabold ">QUICK LINKS</h3>
            <ul className="text-gray-600 space-y-2">
          ...
          <div className="w-full md:w-1/4">
            ...
            <p className="text-gray-600 mb-4 text-xs ">Sign up to our newsletters and don’t miss new arrivals, the latest fashion updates, and our promotions.</p>
            <form className="flex">
              <input
                type="email"
              ...
              />
              <button className="bg-black text-white px-6 py-2 rounded-r-md text-xs ">SUBMIT</button>
            </form>
          </div>
        </div>
